...
As the child demonstrates maturity, parents can gradually enable more features. This teaches moderation rather than abstinence-then-binge.
...
*   [Why don't we have this already?]
    ...
    But even with perfect tools, they only work if parents know about and use them.
    -> Parent_Education

*   [This makes sense. What else?]
    Education is the other crucial piece.
    -> Parent_Education
